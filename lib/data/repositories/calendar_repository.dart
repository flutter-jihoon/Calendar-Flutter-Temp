  ...
  FutureOr<List<ScheduleEvent>?> getScheduleEvents({
    ...
    return [
      ScheduleEvent(
        ...
        isRecurring: true,
        isAllDay: true,
        originalInstanceStartDate: '2025-03-12 16:30:00',
        originalInstanceEndDate: '2025-03-13 17:30:00',
        title: '테스트 이벤트 1',
        location: '테스트 장소',
        colorType: 1,
      ...
      ScheduleEvent(
        ...
        isRecurring: true,
        isAllDay: true,
        originalInstanceStartDate: '2025-03-15 16:30:00',
        originalInstanceEndDate: '2025-03-15 17:30:00',
        title: '테스트 이벤트 2',
        location: '테스트 장소',
        colorType: 1,
        isScreenLockMode: true,
